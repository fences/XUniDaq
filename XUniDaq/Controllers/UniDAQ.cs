...
namespace UniDAQ_Ns
{
    ...
    public class UniDAQ
    {
        ...
        //Callback functions
        [DllImport("UniDAQ.dll")]
        //public static extern UInt16 Ixud_SetEventCallback(UInt16 wBoardNo, UInt16 wEventType, UInt16 wIntSource, ref UIntPtr hEvent, CallBackFun CallbackFunction, UInt32 dwCallbackParameter);
        public static extern UInt16 Ixud_SetEventCallback(UInt16 wBoardNo, UInt16 wEventType, UInt16 wIntSource, /*ref UInt32*/ out IntPtr hEvent, CallBackFun CallbackFunction, UInt32 dwCallbackParameter);
